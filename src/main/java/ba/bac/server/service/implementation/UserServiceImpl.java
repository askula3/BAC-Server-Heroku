...
import ba.bac.server.io.entity.PasswordResetTokenEntity;
import ba.bac.server.io.entity.UserEntity;
import ba.bac.server.io.repository.PasswordResetTokenRepository;
import ba.bac.server.io.repository.UserRepository;
import ba.bac.server.service.EmailService;
import ba.bac.server.service.UserService;
import ba.bac.server.shared.Utils;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto createUser(UserDto user) {
        ...
        String publicUserId = utils.generateUserId(7);
...
//                true, new ArrayList<>());
    ...
    public UserDto updateUser(String userId, UserDto user) {
        ...
        userEntity.setSpecialization(user.getSpecialization());
    ...
    @Override
    public boolean updateRegisterStep(String userId, int step) {
        boolean returnValue = false;

        UserEntity userEntity = userRepository.findByUserId(userId);

        if (userEntity != null) {
            userEntity.setRegisterStep(step);
